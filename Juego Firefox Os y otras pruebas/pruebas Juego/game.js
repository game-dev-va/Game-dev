//Crea el objeto canvas
	...
	//var imgListCactus = new Array();
	var imgListPuntos = new Array();
	var imgListCactus = new Array();
	var imgListPlataforma = new Array();
	var imgListBarranco= new Array();
	...
	var cambioposicion=false;
	var monoarriba=false;
	...
	controlA[1]=controlA[14]=controlA[38]=controlA[42]=cactus;
...
function iniciajuego() {
  ...
  document.getElementsByTagName('BODY')[0].appendChild(imgp);
   // fIN CARGA DE PLATANOS
     ...
     // CARGAMOS LOS cactus IGUAL QUE LAS IMAGENES DEL MONO (ANTERIOR)
  imgListCactus.push(new Image());
  imgListCactus[0].src="img/cactus.png";
  var imgcactus= document.createElement('IMG');
  imgcactus.src=imgListCactus[0].src;
  imgcactus.className='precarga';
  imgcactus.elemento=imgListCactus[0];
  document.getElementsByTagName('BODY')[0].appendChild(imgcactus);
   // fIN CARGA DE PLATANOS
   
     // CARGAMOS LOS plataforma IGUAL QUE LAS IMAGENES DEL MONO (ANTERIOR)
  imgListPlataforma.push(new Image());
  imgListPlataforma[0].src="img/grass20.png";
  var imgplat= document.createElement('IMG');
  imgplat.src=imgListPlataforma[0].src;
  imgplat.className='precarga';
  imgplat.elemento=imgListPlataforma[0];
  document.getElementsByTagName('BODY')[0].appendChild(imgplat);
   // fIN CARGA DE PLATANOS
   
        // CARGAMOS LOS Barranco IGUAL QUE LAS IMAGENES DEL MONO (ANTERIOR)
  imgListBarranco.push(new Image());
  imgListBarranco[0].src="img/dead20.png";
  var barr= document.createElement('IMG');
  barr.src=imgListBarranco[0].src;
  barr.className='precarga';
  barr.elemento=imgListBarranco[0];
  document.getElementsByTagName('BODY')[0].appendChild(barr);
   // fIN CARGA DE PLATANOS
